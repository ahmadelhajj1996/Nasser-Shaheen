const translations = {
  en: {
    ...
    heroTitle: "Nasser Abdulaziz Shaheen for Law and Legal Consultations. ",
    heroSubtitle:
      "Providing exceptional legal services with integrity, dedication and extensive experience.",
    ...
    aboutUs: "About Us",
    aboutHeader:
      "  for a long time  of dedicated legal practice, Al Nasser Legal  brings unmatched expertise and a proven track record of success to every case. our firm is committed to delivering strategic, results-driven representation tailored to each client’s unique needs. ",
    aboutQuestion: "Why Choose Al Nasser Legal ?",

    aboutListItem1: "Long experience in legal work",
  ...
  ar: {
    ...
    heroTitle: " ناصر عبدالعزيز شاهين للمحاماة والاستشارات القانونية ",
    heroSubtitle: "نقدم خدمات قانونية استثنائية بنزاهة وتفانٍ .",
    ...
    aboutUs: "حول خدماتنا ",
    aboutHeader:
      "  مع مسيرة طويلة في الممارسة القانونية المخصصة، يجلب مكتب الناصر القانوني خبرة لا مثيل لها وسجلًا حافلًا بالنجاح في كل قضية. يلتزم مكتبنا  بتقديم تمثيل استراتيجي مدفوع بالنتائج مصمم خصيصًا لتلبية الاحتياجات الفريدة لكل عميل. ",
    aboutListItem1: "خبرة طويلة في العمل القانوني",
